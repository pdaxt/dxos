...
const MODEL_CATALOG: &[ModelEntry] = &[
    ModelEntry {
        ...
        tool_use: 5,
        speed: "~30 tok/s",
        description: "Best tool-use model at this size. Recommended for DXOS.",
        ollama_id: "qwen3:8b",
    ...
    ModelEntry {
        ...
        tool_use: 4,
        speed: "~50 tok/s",
        description: "Lightweight but capable. Good for older machines.",
        ollama_id: "qwen3:4b",
    ...
    ModelEntry {
        ...
        tool_use: 3,
        speed: "~80 tok/s",
        description: "Ultra-light. Basic tool use, fast responses.",
    ...
    ModelEntry {
        ...
        tool_use: 3,
        speed: "~35 tok/s",
        description: "Fast and capable. Weaker tool calling.",
        ollama_id: "mistral:latest",
    ...
    ModelEntry {
        ...
        tool_use: 5,
        speed: "~20 tok/s",
        description: "Mistral's coding specialist. Excellent but large.",
